...
public class UtilPropLuo {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\bb\\CSCI4830-TheRestReserv\\CSCI4830_TheRestReserv\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/CSCI4830_TheRestReserv/config.properties";
