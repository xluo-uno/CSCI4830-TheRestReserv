...
@WebServlet("/SearchRestReserv")
public class SearchRestReserv extends HttpServlet {
   private static final long serialVersionUID = 1L;

   public SearchRestReserv() {
      super();
   }
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            String selectSQL = "SELECT * FROM theRestReserv";
            preparedStatement = connection.prepareStatement(selectSQL);
         } else {
            String selectSQL = "SELECT * FROM theRestReserv WHERE EMAIL LIKE ?";
         ...
         while (rs.next()) {
            ...
            String restName = rs.getString("restname").trim();
            ...
            if (keyword.isEmpty() || email.contains(keyword)) {
               ...
               out.println("Restraurant name: " + restName + "<br>");
            }
         }
